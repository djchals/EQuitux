...
// strcpy(range_pkr[4],"Ks6c, Kc6d, Kc6h, QdJh, QdJc, QhJd, QhJc, QsJd, QsJh, QsJc, QcJd, QcJh, Qd8s, Qd8c, Qh8s, Qh8c, Qs8c, Qc8s, Qd6h, Qd6c, Qh6d, Qh6c, Qs6d, Qs6h, Qs6c, Qc6d, Qc6h");
// strcpy(range_pkr[5],"QcJc, JdTd, JhTh, JcTc, Jd9d, Jh9h, Jc9c, As8s, Ac8c, Ks8s, Kc8c, Qs8s, Qc8c, Jc8c, Ts8s, Tc8c, 9s8s, 9c8c, Jd7d, Jh7h, Jc7c, 8s7s, 8c7c, Ad6d, Ah6h");

// strcpy(range_pkr[0],"AhAc");
// strcpy(range_pkr[1],"KcKs");
// strcpy(range_pkr[2],"QsQc");
// strcpy(range_pkr[3],"AsKh");
// strcpy(range_pkr[4],"6h7c");
// strcpy(range_pkr[5],"ThTc");


//     strcpy(range_pkr[0],"8s8c,6d6h,6d6c");
//     strcpy(range_pkr[1],"77-22,A9s-A2s");

 strcpy(range_pkr[0],"77-22, A9s-A2s, K9s-K2s, QTs-Q2s, J2s+, T2s+, 93s+, 84s+, 74s+, 63s+, 53s+, ATo-A2o, K2o+, Q3o+, J5o+, T6o+, 96o+, 86o+, 76o");
strcpy(range_pkr[1],"Ks6c, Kc6d, Kc6h, QdJh, QdJc, QhJd, QhJc, QsJd, QsJh, QsJc, QcJd, QcJh, Qd8s, Qd8c, Qh8s, Qh8c, Qs8c, Qc8s, Qd6h, Qd6c, Qh6d, Qh6c, Qs6d, Qs6h, Qs6c, Qc6d, Qc6h");
strcpy(range_pkr[2],"QcJc, JdTd, JhTh, JcTc, Jd9d, Jh9h, Jc9c, As8s, Ac8c, Ks8s, Kc8c, Qs8s, Qc8c, Jc8c, Ts8s, Tc8c, 9s8s, 9c8c, Jd7d, Jh7h, Jc7c, 8s7s, 8c7c, Ad6d, Ah6h");

//     strcpy(range_pkr[0],"2h2c,A5s-A2s,K5s-K2s,Q4s-Q2s");
//     strcpy(range_pkr[1],"ATs+,KTs+,QTs+,JTs");
...
//             printf("%x%x %x%x %x%x - %x%x - %x%x \n",local_board[0],local_board[1],local_board[2],local_board[3],local_board[4],local_board[5],local_board[6],local_board[7],local_board[8],local_board[9]);
            memcpy(arr_all_boards[act_t_r],local_board,sizeof(int)*10);
            ++act_t_r;
        }
    }
}
