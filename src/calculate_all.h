//init the vars
long int tot_combos;//total combos analized
double tot_win_pos[9]={};//save in each index the result when this position have the highest score
double tot_tied_pos[9]={};
float tot_win_pcent[9];
float tot_tied_pcent[9];
double tie;
float tot_tie;//save here when the hand is tied
//
