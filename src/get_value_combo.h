...
//                arr_int_to_let[hero_all[13]] );
    ...
    if(hand_value[0]==0 && hand_value[1]==0 && hand_value[2]==0){
        return (0x10*hero_all[13])+hero_all[11];//dont waste time is high card
    }
        ...
        if(max_1==2 && max_2==0){
            ...
            for(i=13;i>=0;i=i-2){
                if(hero_all[i]!=card_1 && hero_all[i]!=card_2){
                    value_kicker=hero_all[i];
                    break;
                }
            }        
            return 0x100000+(card_1*0x100)+value_kicker; 
            ...
            return 0x200000+(card_1*0x100)+(card_2*0x10)+value_kicker;
            ...
            return 0x300000+(card_1*0x100)+value_kicker;//no kicker here
            ...
            return 0x700000+(card_1*0x100)+value_kicker;
        }
        return 0;   
    }
}
